...
promote_rule{T<:Integer,S<:Float64}(::Type{Array{T,1}}, ::Type{Array{S,1}} ) = Array{S,1}
...
promote_rule{T<:Integer,S<:Float64}(::Type{Array{Rational{T},1}}, ::Type{Array{S,1}})  = Array{promote_type(T,S), 1}
